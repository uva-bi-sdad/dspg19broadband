...
write.csv(acs_est2, file = "./data/working/acs_2012-16/acs_2012-16_raw.csv", row.names = F)
write.csv(acs_estimates, file = "./data/working/acs_2012-16/acs_2012-16_calc.csv", row.names = F)
