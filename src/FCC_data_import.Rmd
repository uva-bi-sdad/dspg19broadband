...
## Tried and failed - historic files have weird permissions and need to be transported via SFTP. Reference XWiki /Analysis page on FCC data for more information.
